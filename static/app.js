...
const STORAGE_KEY = "dyhouse_waitlist_preview";
...
function simulateSubmit(payload) {
  // Troque este bloco por um fetch real para o endpoint quando quiser conectar backend.
...
async function handleSubmit(event) {
  ...
  try {
    const response = await simulateSubmit(payload);
